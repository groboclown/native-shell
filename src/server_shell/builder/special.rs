...
pub fn get_main_node<'a, SG: super::sequence::SequenceGen<'a>>(sgen: &'a SG) -> Result<&'a super::parse_node::ModuleNode, super::errors::BuilderError> {
    sgen.get_node_named(&model::Source {
        file: "--generator--".to_string(), column: 0, line: 0, text: None,
    }, &MAIN_NODE.to_string())
}

pub fn get_main_node_seq_id<'a, SG: super::sequence::SequenceGen<'a>>(sgen: &'a SG) -> Result<usize, super::errors::BuilderError> {
    sgen.graph_seq_for_node_named(&model::Source {
        file: "--generator--".to_string(), column: 0, line: 0, text: None,
    }, &MAIN_NODE.to_string())
}
